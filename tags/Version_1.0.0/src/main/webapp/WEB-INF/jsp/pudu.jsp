			...
			<tr>
				...
				<table height="24" border="0" cellpadding="0" cellspacing="0" class="contenidoTexto">
					<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablaTitulo">
							<tr>
								<td class="titular"><spring:message code="what.is.a.pudu"/></td>
							</tr>
						</table>
						</td>
						<td class="contenidoTextoInterno">
							<spring:message code="content.what.is.a.pudu"/>
						</td>
					</tr>
				</table>
				</td>
